...
$toemails[] = array(
				'email' => 'ashley@akaydesign.com', // Your Email Address
				'name' => 'Ashley Kay' // Your Name
			);
...
$fromemail = array(
				'email' => 'ashley@akaydesign.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Website Inquiry' // Company Name
			);
...
$message = array(
	'success'			=> 'I have <strong>successfully</strong> received your Message and will get Back to you as soon as possible.',
...
if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
	...
	$ar_title	= !empty( $submits['ar_title'] ) ? $submits['ar_title'] : 'It is so good to hear from You!';
	...
	$ar_footer	= !empty( $submits['ar_footer'] ) ? $submits['ar_footer'] : 'Copyrights &copy; ' . date('Y') . ' <strong>Ashley Kay</strong>. All Rights Reserved.';
		...
		$html = $html_before . '<!-- / Header -->
									<table border="0" cellpadding="0" cellspacing="0" width="84%" style="width: 84%;">
										<tr>
											...
											<img src="../public/images/AshleyKay.png" alt="Company Logo">
												' . $html_title . '
											</td>
										</tr>
									</table>
